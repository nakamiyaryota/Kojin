...
void StageObjectFix::Init()
{
}

void StageObjectFix::Update()
{
}

void StageObjectFix::Draw()
{
	if (!m_hit)
	{
...
void StageObjectFix::DrawTranslucent()
{
	if (m_hit)
	{
...
void StageObjectFix::SetModel(const std::shared_ptr<KdModelData> spModel)
{
	m_modelWork.SetModel(spModel);
}

bool StageObjectFix::CheckCollisionBump(const SphereInfo& info, BumpResult& result, float dis)
{
