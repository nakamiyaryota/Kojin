...
public:
	...
	void SetProjectionMatrixOrth(float width = D3D.WorkBackBuffer()->GetWidth() * 0.009, float height = D3D.WorkBackBuffer()->GetHeight() * 0.009, float maxRange = 2000, float minRange = 0.01f);
